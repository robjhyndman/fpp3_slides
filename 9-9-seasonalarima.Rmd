...
\begin{block}{A seasonal ARIMA process}
\[
\Phi(B)\phi(B)(1-B)^d(1-B)^Dy_{t} = c + \Theta(B)\theta(B)\varepsilon_t
\]
Need to select appropriate orders: \alert{$d,D,p,q,P,Q$}, and whether to include the intercept \alert{$c$}.
\end{block}
