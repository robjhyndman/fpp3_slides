...
```{r gamma-anim, cache=TRUE, echo=FALSE, fig.show='animate', interval=1/5, message=FALSE, fig.height=4.8, fig.width=8, aniopts='controls,buttonsize=0.3cm,width=11.5cm'}
j07 <- PBS |>
  filter(ATC2 == "J07") |>
...
```{r gamma-static, fig.height=3.8, fig.width=8, echo=FALSE}
...
j07 %>%
  ...
  labs(y = "Cost of scripts ($AUD)",
       title = "Medicare Australia cost of flu vaccine scripts: seasonality")
```
